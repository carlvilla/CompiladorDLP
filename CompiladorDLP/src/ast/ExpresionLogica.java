...
//	expresionLogica:expresion -> left:expresion  string:String  right:expresion ;

public class ExpresionLogica extends AbstractExpresion {

	public ExpresionLogica(Expresion left, String string, Expresion right) {
		this.left = left;
		this.string = string;
		this.right = right;
	...
	public ExpresionLogica(Object left, Object string, Object right) {
