...
//	invocarFuncion:expresion -> string:String  expresion:expresion* ;

public class InvocarFuncion extends AbstractExpresion {

	public InvocarFuncion(String string, List<Expresion> expresion) {
		this.string = string;
	...
	public InvocarFuncion(Object string, Object expresion) {
